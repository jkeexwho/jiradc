...
if (!user) {
    def doesUserExistsField = customFieldManager.getCustomFieldObject("customfield_28407")
...
if (!user.isActive()) {
    ...
    def doesUserDeactivatedField = customFieldManager.getCustomFieldObject("customfield_28408")
